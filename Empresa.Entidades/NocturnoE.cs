...
{
        public class NocturnoE : ClasePersona
        {
            // Atributos 
            ...
            public NocturnoE(string turno)
            {
                Turno = turno;
            }

            public NocturnoE(string turno, int idE, string nombre, string apellidoP, string apellidoS, int cedula, double salario, string email, int celular, int seguro, string motor, string placa)
