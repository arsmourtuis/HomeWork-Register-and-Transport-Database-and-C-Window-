...
namespace Empresa.Entidades
{
    public class DiurnoE : ClasePersona
    {
        ...
        public DiurnoE(string turno, int idE, string nombre, string apellidoP, string apellidoS, int cedula, double salario, string email, int celular, int seguro, string motor, string placa)
