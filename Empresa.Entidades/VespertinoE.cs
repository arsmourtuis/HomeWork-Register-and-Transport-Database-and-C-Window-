...
namespace Empresa.Entidades
{
    public class VespertinoE : ClasePersona
    {
        ...
        public VespertinoE(string turno, int idE, string nombre, string apellidoP, string apellidoS, int cedula, double salario, string email, int celular, int seguro, string motor, string placa)
